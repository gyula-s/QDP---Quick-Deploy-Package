<?php 
/*Gyula Soos - 2015-04-23*/
/*Contact form with validation and email sending facilities */
/*variables to store info from the user*/
...
http://web-kreation.com/all/php-contact-form-script/*/
?>