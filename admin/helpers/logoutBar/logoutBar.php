...
echo '<style type="text/css"> @import url("./helpers/logoutBar/logoutBar.css") </style>'; //inlcude the custom css for it
...
?>
<div id="loggedIn">
<p id="sitenameHeader"> <?php echo $langSettings['siteName']; ?> - <a href="/" target="_blank">Preview Site</a></p>
	<form method="post" >
		<?php 
